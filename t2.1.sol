...
contract task2 {
    ...
    uint32[2][4] b = [[22,3], [1,2], [12,12], [3,4]]; //статический двумерный массив
    ...
    function addLine(string memory _s) public {
        lines.push(_s);
    }

    function getLines() public view returns (string[] memory) {
        return lines;
    }

    function removeLastLine() public {
        lines.pop();
    }
